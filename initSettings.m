...
settings.fileName           = 'GPSdata-DiscreteComponents-fs38_192-if9_55.bin';
%settings.fileName            = 'GPS_and_GIOVE_A-NN-fs16_3676-if4_1304.bin';
...
%settings.IF                 = 16.3676e6;      %[Hz]
%settings.samplingFreq       = 4.1304e6;     %[Hz]
